<template>
  <div
    class="w-64 z-10 absolute h-screen sm:relative bg-indigo-900 shadow flex-col justify-between hidden sm:flex flex-grow-0 flex-shrink-0"
  >
  ...
  <div
    class="w-48 z-10 absolute sm:relative bg-indigo-900 shadow h-screen flex-col justify-between sm:hidden transition duration-150 ease-in-out"
    id="mobile-nav"
  >
    <div
...
export default {
  ...
  mounted() {
    ...
    sideBar.style.transform = "translateX(-192px)";
  },
  methods: {
    sidebarHandler() {
      var sideBar = document.getElementById("mobile-nav");
